...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO four_wheeler_services (service_name, description, original_price, offer_price, 
    ...
    if (mysqli_query($conn, $query)) {
        $_SESSION['message'] = ['type' => 'success', 'text' => 'Four wheeler service added successfully!'];
    } else {
